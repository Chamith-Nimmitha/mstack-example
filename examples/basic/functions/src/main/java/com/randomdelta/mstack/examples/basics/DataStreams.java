	...
	public static void main(String[] args) throws InterruptedException {
		BaseServer baseServer = new BaseServer(ServerConfig.builder()
				...
				.withFunction(RFunction.builder()
						.withName("DataStreamFunction")
						.withFuncType(DataStreamFunction.class).build())
				.build());
		baseServer.start();

		baseServer.stream("DataStreamFunction", TMessage.builder().withData("Chamith").build()).subscribe(s -> System.out.println(s));
